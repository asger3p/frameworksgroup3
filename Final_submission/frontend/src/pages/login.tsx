...
function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    // async marks a function as “returns a promise”
    ...
    login({
      ...
      mail: found.mail,
      password,
    }); // this call saves the user object in AuthContext + writes it to localStorage so the session persists across refreshes
